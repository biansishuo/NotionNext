...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'a6cf5bdb7d3246c9bdd7744d505bc849',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '法益是入罪的基础，伦理是出罪的依据',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '卞思硕', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一位实习律师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xianhuan.co', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '法律','北京', '刑辩', '律师', '河北', '广东','合同','刑事'// 网站关键词 英文逗号隔开
